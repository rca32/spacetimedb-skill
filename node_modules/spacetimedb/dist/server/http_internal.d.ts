...
declare const makeResponse: unique symbol;
...
export declare class SyncResponse {
    ...
    static [makeResponse](body: BodyInit | null, inner: InnerResponse): SyncResponse;
    get headers(): Headers;
    get status(): number;
    get statusText(): string;
    get ok(): boolean;
    get url(): string;
    get type(): "error" | "default" | "basic" | "cors" | "opaque" | "opaqueredirect";
...
//# sourceMappingURL=http_internal.d.ts.map