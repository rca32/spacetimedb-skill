 ...
 * @returns The converted string
 */
export declare function toCamelCase<T extends string>(str: T): CamelCase<T>;
...
export declare function bsatnBaseSize(typespace: Infer<typeof Typespace>, ty: AlgebraicType): number;
