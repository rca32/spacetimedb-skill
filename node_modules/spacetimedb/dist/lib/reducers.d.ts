...
import { ColumnBuilder, RowBuilder, type Infer, type InferTypeOfRow, type RowObj, type TypeBuilder } from './type_builders';
 ...
 */
export declare function pushReducer(name: string, params: RowObj | RowBuilder<RowObj>, fn: Reducer<any, any>, lifecycle?: Infer<typeof RawReducerDefV9>['lifecycle']): void;
 ...
 * ```
 */
export declare function reducer<S extends UntypedSchemaDef, Params extends ParamsObj>(name: string, params: Params, fn: (ctx: ReducerCtx<S>, payload: ParamsAsObject<Params>) => void): void;
/**
