...
pub use v2::{
    AudioEventV2, AudioEventV2 as AudioEvent, CombatHitEventV2, CombatHitEventV2 as CombatHitEvent,
    FxEventV2, FxEventV2 as FxEvent,
    ...
    ServerCorrectionV2 as ServerCorrection, UiNotificationEventV2,
    UiNotificationEventV2 as UiNotificationEvent,
};
