import { a as World, Q as QueryParameter, p as QueryResult, E as Entity, h as TagTrait, e as Trait, R as Relation, J as TraitRecord } from '../dist/types-DiONxA5q.js';
...
declare function useHas(target: Entity | World | undefined | null, trait: Trait): boolean;
...
declare function useTrait<T extends Trait>(target: Entity | World | undefined | null, trait: T): TraitRecord<T> | undefined;
