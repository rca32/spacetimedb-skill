...
// node_modules/koota/dist/chunk-YHJT6WPS.js
...
function createAdded() {
  ...
  return (...inputs) => {
    const traits = inputs.map((input) => (input == null ? void 0 : input[$relation]) ? input[$internal].trait : input);
...
function checkQuery(world, query, entity) {
  ...
  for (let i = 0; i < generations.length; i++) {
    ...
    const or = bitmask.or;
    const entityMask = ((_a2 = ctx.entityMasks[generationId]) == null ? void 0 : _a2[eid]) || 0;
...
function setupOrderedTraitSync(world, orderedTrait) {
  ...
  const getList = (parent) => {
    ...
    return ((_a2 = entityMasks[generationId]) == null ? void 0 : _a2[eid]) & bitflag ? traitCtx.get(eid, store) : void 0;
  };
  relationInstance.addSubscriptions.add((child, parent) => {
    var _a2;
    (_a2 = getList(parent)) == null ? void 0 : _a2._appendWithoutSync(child);
  });
  relationInstance.removeSubscriptions.add((child, parent) => {
    ...
    if (denseIdx !== void 0 && (entityIndex.dense[denseIdx] & ENTITY_ID_MASK) === eid) {
      (_a2 = getList(parent)) == null ? void 0 : _a2._removeWithoutSync(child);
    }
  });
}
var OrderedList = class extends Array {
  constructor(world, parent, relation2, orderedTrait, items = []) {
    ...
    __publicField(this, "orderedTrait");
    __publicField(this, "_syncing", false);
    this.world = world;
    this.parent = parent;
...
function addTrait(world, entity, ...traits) {
  for (let i = 0; i < traits.length; i++) {
    ...
    if (config == null ? void 0 : config[$relationPair]) {
      ...
      if (typeof target_6_$f !== "number") {
        ...
        if (result_hasRelationToTarget_7_$f) {
          ...
          if (relationCtx_6_$f.exclusive) {
            ...
            if (!traitData_8_$f || !traitData_8_$f.relationTargets) {
              ...
              if (relationCtx_8_$f.exclusive) {
                ...
                result_getFirstRelationTarget_8_$f = targets_8_$f == null ? void 0 : targets_8_$f[0];
              }
            }
          ...
          if (targetIndex_6_$f === -1) {
            ...
            const schema_6_$f = (instance_6_$f == null ? void 0 : instance_6_$f.schema_6_$f) ?? world[$internal].traitInstances[relationTrait_6_$f.id].schema;
...
function removeTrait(world, entity, ...traits) {
  for (let i = 0; i < traits.length; i++) {
    ...
    if (trait2 == null ? void 0 : trait2[$relationPair]) {
...
function createRelation(definition) {
  const relationTrait = trait((definition == null ? void 0 : definition.store) ?? {});
  const traitCtx = relationTrait[$internal];
  traitCtx.relation = null;
  let autoDestroy = false;
  if ((definition == null ? void 0 : definition.autoDestroy) === "orphan" || (definition == null ? void 0 : definition.autoDestroy) === "source") {
    autoDestroy = "source";
  } else if ((definition == null ? void 0 : definition.autoDestroy) === "target") {
    autoDestroy = "target";
  }
  if (definition == null ? void 0 : definition.autoRemoveTarget) {
    console.warn(`Koota: 'autoRemoveTarget' is deprecated. Use 'autoDestroy: "orphan"' instead.`);
    autoDestroy = "source";
  }
  const relationCtx = {
    trait: relationTrait,
    exclusive: (definition == null ? void 0 : definition.exclusive) ?? false,
    autoDestroy
  };
...
function setRelationDataAtIndex(world, entity, relation2, targetIndex, value) {
  ...
  if (relationCtx.exclusive) {
    ...
    for (const key in value) {
      ((_a2 = store[key])[eid] ?? (_a2[eid] = []))[targetIndex] = value[key];
    }
  }
}
...
function getRelationData(world, entity, relation2, target) {
  ...
  if (traitCtx.type === "aos") {
    if (relationCtx.exclusive) {
      ...
      return (_a2 = store[eid]) == null ? void 0 : _a2[targetIndex];
    }
  } else {
    const result = {};
    ...
    for (const key in store) {
      if (relationCtx.exclusive) {
        ...
        result[key] = (_b = storeRecord[key][eid]) == null ? void 0 : _b[targetIndex];
      }
    }
    return result;
  }
...
var _dense, _sparse, _cursor, _a;
var SparseSet = (_a = class {
  constructor() {
...
}, _dense = new WeakMap(), _sparse = new WeakMap(), _cursor = new WeakMap(), _a);
...
function createQueryResult(world, entities, query, params) {
  ...
  for (let i_0_$f = 0; i_0_$f < params.length; i_0_$f++) {
    ...
    if (param_0_$f == null ? void 0 : param_0_$f[$relationPair]) {
    ...
    if (param_0_$f == null ? void 0 : param_0_$f[$modifier]) {
  ...
  const results = Object.assign(entities, {
    ...
    select(...params2) {
      ...
      for (let i_10_$f = 0; i_10_$f < params2.length; i_10_$f++) {
        ...
        if (param_10_$f == null ? void 0 : param_10_$f[$relationPair]) {
        ...
        if (param_10_$f == null ? void 0 : param_10_$f[$modifier]) {
...
var createQueryHash = (parameters) => {
  ...
  for (let i = 0; i < parameters.length; i++) {
    ...
    if (param == null ? void 0 : param[$relationPair]) {
    ...
    } else if (param == null ? void 0 : param[$modifier]) {
...
function createQueryInstance(world, parameters) {
  ...
  for (let i = 0; i < parameters.length; i++) {
    ...
    if (parameter == null ? void 0 : parameter[$relationPair]) {
    ...
    if (parameter == null ? void 0 : parameter[$modifier]) {
    ...
    for (const group of query.trackingGroups) {
      ...
      for (const entity of ctx.entityIndex.dense) {
        ...
        for (let genId = 0; genId < bitmasks.length; genId++) {
          ...
          if (!mask) continue;
          const oldMask = ((_a2 = snapshot[genId]) == null ? void 0 : _a2[eid]) || 0;
          const currentMask = ((_b = ctx.entityMasks[genId]) == null ? void 0 : _b[eid]) || 0;
          for (let bit = 1; bit <= mask; bit <<= 1) {
            ...
            switch (type) {
              case "add":
                ...
                break;
              case "remove":
                traitMatches = (oldMask & bit) === bit && (currentMask & bit) === 0 || (oldMask & bit) === 0 && (currentMask & bit) === 0 && ((((_c = dirtyMask[genId]) == null ? void 0 : _c[eid]) ?? 0) & bit) === bit;
                break;
              case "change":
                traitMatches = ((((_d = changedMask[genId]) == null ? void 0 : _d[eid]) ?? 0) & bit) === bit;
                break;
            }
            if (logic === "and") {
              if (!traitMatches) {
...
Number.prototype.has = function(trait2) {
  ...
  if (trait2 == null ? void 0 : trait2[$relationPair]) return hasRelationPair(world, this, trait2);
...
Number.prototype.targetFor = function(relation2) {
  ...
  if (!traitData_11_$f || !traitData_11_$f.relationTargets) {
    ...
    if (relationCtx_11_$f.exclusive) {
      ...
      result_getFirstRelationTarget_11_$f = targets_11_$f == null ? void 0 : targets_11_$f[0];
    }
  }
...
function createWorld(optionsOrFirstTrait, ...traits) {
  ...
  const world = {
    ...
    query(...args) {
      var _a2, _b;
      const ctx = world[$internal];
      if (args.length === 1 && ((_a2 = args[0]) == null ? void 0 : _a2[$queryRef])) {
        ...
        const params = args;
        if (params.length === 1 && ((_b = params[0]) == null ? void 0 : _b[$relationPair])) {
    ...
    onQueryAdd(args, callback) {
      const ctx = world[$internal];
      let query;
      if (args == null ? void 0 : args[$queryRef]) {
        const queryRef = args;
    ...
    onAdd(trait2, callback) {
      const ctx = world[$internal];
      const target = (trait2 == null ? void 0 : trait2[$relation]) ? trait2[$internal].trait : trait2;
