...
function SpacetimeDBProvider({
  ...
  const connRef = React__namespace.useRef(null);
  const cleanupTimeoutRef = React__namespace.useRef(
    null
  );
  const getConnection = React__namespace.useCallback(() => connRef.current, []);
