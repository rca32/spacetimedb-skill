...
import { type RowTypedQuery } from '../lib/query';
export declare class SubscriptionBuilderImpl<RemoteModule extends UntypedRemoteModule> {
     ...
     * ```
     */
    subscribe(query_sql: string | RowTypedQuery<any, any>): SubscriptionHandleImpl<RemoteModule>;
    subscribe(query_sql: Array<string | RowTypedQuery<any, any>>): SubscriptionHandleImpl<RemoteModule>;
    /**
