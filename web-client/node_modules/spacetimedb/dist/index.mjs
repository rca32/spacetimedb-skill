...
function resolveTableRef(source) {
  ...
  #makeReadonlyIndex(tableDef, idx) {
    ...
    const matchRange = (row, rangeArg) => {
      ...
      if (lastProvided && typeof lastProvided === "object" && "from" in lastProvided && "to" in lastProvided) {
        const from2 = lastProvided.from;
        const to = lastProvided.to;
        if (from2.tag !== "unbounded") {
          const c = scalarCompare(kLast, from2.value);
          if (c < 0) return false;
          if (c === 0 && from2.tag === "excluded") return false;
        }
        if (to.tag !== "unbounded") {
