  ...
  const ctx = {
    ...
    withTx(body) {
      const run = () => {
        ...
        try {
          const ctx2 = freeze2(
            makeReducerCtx(sender, new Timestamp(timestamp2), connectionId)
          );
          return body(ctx2);
        } catch (e) {
...
var makeReducerCtx = (sender, timestamp, connectionId) => ({
  sender,
  get identity() {
    return new Identity(sys.identity().__identity__);
  },
