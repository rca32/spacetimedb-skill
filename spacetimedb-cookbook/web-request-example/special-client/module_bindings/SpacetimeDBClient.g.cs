...
namespace SpacetimeDB.Types
{
    ...
    public sealed partial class RemoteTables : RemoteTablesBase
    {
        ...
        {
            AddTable(KnownIdentities = new(conn));
            AddTable(Weather = new(conn));
            AddTable(WebRequests = new(conn));
        }
    }
    ...
    public sealed class DbConnection : DbConnectionBase<DbConnection, RemoteTables, Reducer>
    {
        ...
        protected override Reducer ToReducer(TransactionUpdate update)
        {
            ...
            {
                "AddKnownIdentity" => BSATNHelpers.Decode<Reducer.AddKnownIdentity>(encodedArgs),
                "ClearWeather" => BSATNHelpers.Decode<Reducer.ClearWeather>(encodedArgs),
                "ClientConnected" => BSATNHelpers.Decode<Reducer.ClientConnected>(encodedArgs),
                "RequestWeather" => BSATNHelpers.Decode<Reducer.RequestWeather>(encodedArgs),
                "ReturnWeather" => BSATNHelpers.Decode<Reducer.ReturnWeather>(encodedArgs),
        ...
        protected override bool Dispatch(IReducerEventContext context, Reducer reducer)
        {
            ...
            {
                Reducer.AddKnownIdentity args => Reducers.InvokeAddKnownIdentity(eventContext, args),
                Reducer.ClearWeather args => Reducers.InvokeClearWeather(eventContext, args),
                Reducer.ClientConnected args => Reducers.InvokeClientConnected(eventContext, args),
                Reducer.RequestWeather args => Reducers.InvokeRequestWeather(eventContext, args),
                Reducer.ReturnWeather args => Reducers.InvokeReturnWeather(eventContext, args),
