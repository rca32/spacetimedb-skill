...
- `VITE_TAA_ENABLED` (default: `0`, `1`일 때만 TAA attach)
- `VITE_FXAA_ENABLED` (default: `0`, `1`일 때만 FXAA attach)
- `VITE_PLAYER_PHYSICS_BRIDGE` (default: `0`, `1`일 때만 로컬 Rigidbody 브리지 활성화)
