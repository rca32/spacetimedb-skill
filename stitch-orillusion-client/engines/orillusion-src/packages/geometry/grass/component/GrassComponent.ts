import { BoundingBox, Color, ComponentBase, GPUPrimitiveTopology, LightingFunction_frag, MeshRenderer, Texture, Transform, UnLitMaterial, Vector3, VertexAttributeName } from "@engine/core";
...
export class GrassComponent extends MeshRenderer {
    ...
    public setGrass(grassWidth: number, grassHeight: number, segment: number, density: number, count: number = 1000) {
        ...
        // Grass vertical bend amount is controlled by material uniform in shader.
